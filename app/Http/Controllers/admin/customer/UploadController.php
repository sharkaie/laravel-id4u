...
class UploadController extends Controller
{
    ...
    public function excel(){
      return view('admin.customer.upload.excel');
    }
    ...
    public function photos(Request $request){
      ...
      if($case == 1){
        return view('admin.customer.upload.photos', ['search'=>1, 'search_data'=>$search, 'options'=>$field_options, 'fields'=>$fields, 'data'=>$data]);
      }else{
        return view('admin.customer.upload.photos', ['search'=>0, 'options'=>$field_options,  'fields'=>$fields, 'data'=>$data]);
      }

  return view('admin.customer.upload.photos', ['fields'=>$fields, 'data'=>$data]);
    }
    ...
    public function photos_cropped(Request $request){
      ...
      return view('admin.customer.upload.photo_crop_upload');
    }
