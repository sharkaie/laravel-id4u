    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
              <a href="{{route('fields.show', $customer_id)}}" class="btn btn-label-dark btn-bold btn-sm btn-icon-h kt-margin-l-10"> << Back </a>
            </div>
        </div>
    </div>
  @endsection
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="">Add new Option</h5>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true" class="la la-remove"></span>
				</button>
			</div>
			<form class="kt-form kt-form--fit kt-form--label-left" id="Add_newOption" action="{{route('fields.option.store',$field_id)}}" method="post">
        @csrf
        <div class="modal-body">
            <div class="form-group">
              <label>Option Name</label>
              <input type="text" id="option_name" name="option_name" class="form-control" placeholder="Enter Option Name" autocomplete="new-password" autofocus required>
            </div>
				</div>
              ...
              <tbody>
                @foreach ($options as $option)
                  <tr>
                    ...
                    <div class="modal fade" id="edit{{$option->id}}" role="dialog" aria-labelledby="" aria-hidden="true">
                    	<div class="modal-dialog modal-dialog-centered" role="document">
                    		<div class="modal-content">
                    			...
                    			<form class="kt-form kt-form--fit kt-form--label-left" action="{{route('options.edit',$option->id)}}" method="post">
                            @csrf
                            <div class="modal-body">
                                <div class="form-group">
                                  <label>Option Name</label>
                    ...
                    <form id="delete{{$option->id}}" action="{{route('fields.delete_option', $option->id)}}" style="display:none;" method="post">
                      @csrf;
                      @method('delete')
                    </form>
                  <a href="#" onclick="
