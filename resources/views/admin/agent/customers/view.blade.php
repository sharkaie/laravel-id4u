...
<div class="modal fade" id="add_customer_modal" role="dialog" aria-labelledby="" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form class="kt-form kt-form--fit kt-form--label-left" id="Add_NewCustomer" action="{{route('customers.store')}}" method="post">
        @csrf
        <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" id="company_name" name="company_name" class="form-control" aria-describedby="company_name" placeholder="Enter Company Name" required>
            ...
            <div class="form-group">
              ...
              <input type="text" id="username" name="username" value="{{$username}}" class="form-control" aria-describedby="username" placeholder="Enter Username" autocomplete="new-password">
              ...
              <tbody>
                @foreach ($customers as $customer)
                  <tr>
                    ...
                    <td>{{$customer->company_contact}}</td>
                    ...
                    <td>
                      <form id="delete{{$customer->id}}" action="{{route('customers.destroy', $customer->id)}}" style="display:none;" method="post">
                        @csrf;
                        @method('delete')
                      </form>
                      <a href="{{route('customers.edit', $customer->id)}}" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit">
