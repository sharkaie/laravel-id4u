...
@section('main-content')
	...
	<div class="kt-portlet kt-portlet--mobile">
		...
		<div class="kt-portlet__head-actions">
			<a href="{{route('datas.uexport')}}" target="_blank"  class="btn btn-default btn-icon-sm" ><i class="la la-download"></i> Export
			</a>
		</div>
	</div>
	</div>
		...
		@foreach ($datas as $data)
			...
			<form action="{{route('datas.change_status_verify')}}" id="change-status-verify-{{$data->id}}" method="post">
				@csrf
		...
		<div class="kt-portlet__body">
			<div class="row">
				<form id="filter" class="col-xl-12 col-lg-12 col-md-12 col-sm-12" action="{{route('datas.unverified')}}" method="post">
					@csrf
			...
			<form action="{{route('datas.change_status_verify')}}" id="multiple-verify-form" method="post">
				@csrf
