    ...
    <body style="background: #fff8eb;">
      ...
      <div class="kt-grid kt-wizard-v3" id="kt_wizard_v3" data-ktwizard-state="step-first" >
        ...
        <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v3__wrapper" style="background: #fff8eb;">
          ...
          <form class="kt-form" id="kt_form" enctype="multipart/form-data" method="post" data-route="{{route('datas.getedit')}}">
            @csrf
                ...
                <div class="kt-wizard-v3__form">
                  ...
                  <div class="form-group">
        							<div class="kt-checkbox-inline">
        								...
        								<input type="checkbox" name="accept" required> I accept that the above information is correct
        								<span></span>
        								</label>
        							</div>
        					</div>
