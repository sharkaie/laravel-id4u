...
<base href="../../../../"><!--end::Base Path -->
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700|Roboto:300,400,500,600,700">        <!--end::Fonts -->
                    ...
                    <!--begin::Page Custom Styles(used by this page) -->
                             <link href="{{asset('admin/assets/css/demo1/pages/login/login-3.css')}}" rel="stylesheet" type="text/css" />
...
<link href="{{asset('admin/assets/css/demo1/skins/aside/dark.css" rel="stylesheet" type="text/css')}}" />        <!--end::Layout Skins -->
	...
	<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({{url('admin/assets/media//bg/bg-3.jpg')}});">
		<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
          ...
          <div class="kt-login__head">
						...
						<div class="kt-login__desc">Enter your Username to send Reset password link:</div>
          ...
          @endif
					<form class="kt-form" id="reset-password" action="{{route('admin.password.update')}}" method="post">
            @csrf
            <input type="hidden" name="token" value="{{ $token }}">
            <div class="input-group">

							<input class="form-control @error('username') is-invalid @enderror" id="username" type="text" placeholder="Username" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                @error('username')
            ...
            <div class="input-group">
							...
							<input class="form-control @error('password') is-invalid @enderror" id="password" type="password" placeholder="New Password" name="password"  required autocomplete="new-password">
                @error('password')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
