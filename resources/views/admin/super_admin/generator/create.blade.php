...
@section('page-title', 'ID Card Generator')
...
@section('main-content')
    ...
    @endif
		...
		<div class="kt-portlet">
			...
			<!--begin::Form-->
			<form class="kt-form kt-form--label-left" method="post" action="{{route('id-generator.store')}}">
        @csrf
				<div class="kt-portlet__body">
					<div class="form-group row">
						<div class="col-lg-6">
							<label>Project Title</label>
  							<input type="text" class="form-control @error('project_title') is-invalid @enderror" name="project_title" id="project_title" placeholder="Enter Project Title" required>
                @error('project_title')
