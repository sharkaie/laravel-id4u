...
@section('page-title', 'ID Generator Field Settings')
...
@section('main-content')
			...
			<div class="kt-subheader  kt-grid__item" id="kt_subheader">
					<div class="kt-container  kt-container--fluid ">
							<div class="kt-subheader__main">
									...
									<span class="kt-subheader__desc">{{$project->project_title}}</span>
									@endforeach
							</div>
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">@foreach ($projects as $project)
						<a href="{{ route('id-generator.set_field', $project->id) }}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>Set Field</a>
						@endforeach
					</div>
				</div>
			</div>
            ...
            <tr>
              ...
              <td>
								@foreach ($fields as $field)
									@if ($field->field_id == $project->field_id)
										{{ $field->field_name }}
									@endif
	              @endforeach
							</td>
              ...
              <td>
                <span class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="#"><i class="la la-edit"></i>Field Setting</a>
