...
@section('page-title', 'ID Generator Projects')
	...
	<div class="kt-portlet kt-portlet--mobile">
        ...
        <div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">
						<a href="{{route('id-generator.create')}}" class="btn btn-brand btn-elevate btn-icon-sm"><i class="la la-plus"></i>New Project</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="kt-portlet__body">
			...
			<table class="table table-striped- table-bordered table-hover table-checkable" id="generator_table">
				<thead>
					<tr>
						<td>Sr no</td>
            <td>id</td>
          ...
          @foreach ($projects as $project)
            ...
            <tr>
              ...
              <td>{{$project->project_title}}</td>
							<td>{{$project->card_width}}</td>
							<td>{{$project->card_height}}</td>
              <td><a href="{{route('generator.show_design', ['id'=>$project->id, 'side'=>'S'])}}" target="_blank"><img src="{{$project->card_template_front}}" style ="height:50px;width:auto;" /></a></td>
              <td><a href="{{route('generator.show_design', ['id'=>$project->id, 'side'=>'D'])}}" target="_blank"><img src="{{$project->card_template_back}}" style ="height:50px;width:auto;" /></a></td>
              <td>{{$project->card_type}}</td>
              ...
              <td>
                <span class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" href="{{route('id-generator.project_setting', $project->id)}}"><i class="la la-edit"></i>Field Setting</a>
                        <a class="dropdown-item" href="#"><i class="la la-list-alt"></i>Generate</a>
                    </div>
                </span>
              </td>
						</tr>
