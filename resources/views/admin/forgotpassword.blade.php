...
<html lang="en" >
    ...
    <head><!--begin::Base Path (base relative path for assets of this page) -->
        ...
        <title>ID4U | Forgot Password </title>
...
<link href="{{asset('admin/assets/css/demo1/skins/aside/dark.css" rel="stylesheet" type="text/css')}}" />        <!--end::Layout Skins -->
	...
	<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url({{url('admin/assets/media//bg/bg-3.jpg')}});">
        ...
        {{-- <div class="card-body">
          ...
          @endif
					<form class="kt-form" id="forgot-password" action="{{route('admin.password.email')}}" method="post">
            @csrf
            <div class="input-group">
                ...
                @enderror
						...
						<div class="kt-login__actions">
							<button type="submit" class="btn btn-brand btn-elevate kt-login__btn-primary">Request Link</button>
						</div>
					</form>
				</div>
			</div>
