		...
		<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
			<div class="kt-login__container">
				...
				<div class="kt-login__signin">
					...
					<form class="kt-form" id="admin_login" method="post" action="{{route('admin.login')}}">
            @csrf
						<div class="input-group">
              <input id="username" type="text" placeholder="Enter your Username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
              ...
              <div class="col kt-align-right">
								<a href="{{route('admin.password.request')}}" id="kt_login_forgot" class="kt-login__link">{{ __('Forgot Your Password?') }}</a>
							</div>
						</div>
